...
export function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-dvh min-h-0 min-w-0 overflow-hidden bg-primary-subtle/40">
      <Sidebar />
      {mobileOpen && (
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden pb-[calc(4rem+env(safe-area-inset-bottom))] md:pb-0">
