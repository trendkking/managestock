...
def extra_json(
    ...
    *,
    ...
    if kis_use_virtual is not None:
        payload["kisUseVirtual"] = kis_use_virtual
...
def parse_extra(extra_json_raw: str | None) -> dict:
    ...
    kis_use_virtual = data.get("kisUseVirtual")
    if kis_use_virtual is not None:
        kis_use_virtual = bool(kis_use_virtual)
    return {
